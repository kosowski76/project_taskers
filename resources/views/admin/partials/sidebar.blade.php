...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <div>
            <p class="app-sidebar__user-name">Krzysztof Kosowski</p>
    ...
    <li>
        ...
        <li>
            <a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-dashboard"></i>
            ...
            <ul class="treeview-menu">
                ...
                <li>
                    <a class="treeview-item" href="#" target="_blank" rel="noopener noreferrer">
                        <i class="icon fa fa-circle-o"></i>Staff</a>
                </li>
                <li>
                    <a class="treeview-item" href="#" target="_blank" rel="noopener noreferrer">
                        <i class="icon fa fa-circle-o"></i>Supervisors</a>
                </li>
                <li>
                    <a class="treeview-item" href="#">
                        <i class="icon fa fa-circle-o"></i>Admins</a>
                </li>
            </ul>
        </li>
        <li>
